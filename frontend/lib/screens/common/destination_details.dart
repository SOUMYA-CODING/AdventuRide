...
class _DestinationDetailsState extends State<DestinationDetails>
  ...
  String discoveryDescription =
      "The discovery of Borobudur Temple is an interesting story that involves the efforts of Sir Thomas Stamford Raffles, the British governor of Java, in the early 19th century. Here's more information about the discovery of Borobudur: In 1814, Raffles received information from local villagers about a large, mysterious structure covered in vegetation in Central Java. Intrigued by these accounts, Raffles organized an expedition to investigate the site. He led a team of Dutch and British engineers, surveyors, and workers to the location indicated by the villagers. Upon arriving at the site, they found an overgrown hill covered with dense foliage and trees. After clearing away the vegetation, they discovered the magnificent Borobudur Temple hidden underneath. Raffles and his team began the arduous task of uncovering and documenting the temple. Raffles recognized the historical and cultural significance of the temple. He commissioned sketches and plans to be made, and he wrote a detailed account of the discovery. His efforts were aimed at preserving and showcasing the temple's architectural and artistic treasures. Unfortunately, Raffles' involvement in the discovery of Borobudur was cut short. He was soon called back to England due to political circumstances, and he had to leave Java before the temple could be fully excavated and restored. After Raffles' departure, the Dutch East India Company, which governed Java at the time, continued the work of clearing the site and documenting the temple. They carried out further investigations and initiated restoration efforts. It wasn't until the early 20th century, under Dutch colonial rule, that comprehensive restoration work on Borobudur began. The Dutch government allocated funds and brought in experts to restore the temple to its former glory. The restoration work aimed to stabilize the structure, repair damaged areas, and preserve the intricate stone carvings. The restoration efforts continued intermittently over several decades, with different teams of archaeologists, architects, and experts involved. In 1983, the Indonesian government, with the support of UNESCO and international donors, launched a major restoration project to address structural issues and preserve the temple for future generations. Thanks to the efforts of Raffles and subsequent restoration work, Borobudur Temple was brought back from obscurity and has become one of the most iconic and revered cultural sites in Southeast Asia. Its discovery and subsequent restoration have allowed people from around the world to appreciate and study the temple's architectural grandeur and artistic significance.";
  @override
